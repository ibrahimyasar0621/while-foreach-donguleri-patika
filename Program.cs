...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (character<'z')
        {
            ...
            character ++;    // karakteri bir arttırıyoruz burada.    ÇIKTI=a harfinden başlayp y harfine kadar alfabeyi yazar. z dahil değil.
        }
        ...
        {
            Console.WriteLine(araba);    //ÇIKTI= BMW   FORD TOYOTA NİSSAN
        }
    }
}
